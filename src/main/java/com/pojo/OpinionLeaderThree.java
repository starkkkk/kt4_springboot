...
public class OpinionLeaderThree implements Serializable {
    private Long id;
    private String name;
    ...
    public double getBetween1() {
        return between1;
    }
    public void setBetween1(double between1) {
...
//        System.out.println(rank5);
    ...
    public String[] getList1(){
        String[] list1=report.split("qwer");
